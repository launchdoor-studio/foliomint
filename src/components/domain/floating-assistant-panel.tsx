...
export function FloatingAssistantPanel({
  ...
  return (
    ...
    >
      ...
      >
        <header className="flex shrink-0 items-center gap-3 border-b-2 border-foreground/15 px-4 py-3 dark:border-white/10">
          {header}
        </header>
        ...
        {footer && (
          <footer className="shrink-0 border-t-2 border-foreground/15 px-4 py-3 dark:border-white/10">
            {footer}
          </footer>
        )}
      </div>
